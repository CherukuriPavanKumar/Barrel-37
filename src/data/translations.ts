...
export const TRANSLATIONS: Record<Language, TranslationDict> = {
  en: {
    ...
    brandSub: 'PREMIUM SHOT BAR',

    heroPreTitle: 'Est. 2026 · Premium Bar & Restaurant',
    heroTitle1: '',
    heroTitle2: 'BARREL37',
    heroTitle3: 'Bar • Restaurant • Cocktails • Burgers',
    heroDesc: 'Hand-curated spirits, intimate atmosphere, and an unforgettable dining experience.',
    ...
    findHoursMonThu: 'Mon –  Closed',
    findHoursFriSat: 'Tue – Sun   11:00 AM – 12:00 AM',
    findHoursSunday: '',
    findReservationsLbl: 'Reservations',
    findReservationsVal: '+48 12 345 67 89',
    findEmailLbl: 'E-mail',
    findEmailVal: 'joinusbarrel37@gmail.com',
    ...
    resPre: 'Reservations',
    resDesc: 'All table booking inquiries should be sent to: joinusbarrel37@gmail.com',
  ...
  pl: {
    ...
    heroPreTitle: 'Zał. 2026 · Premium Bar & Restaurant',
    heroTitle1: '',
    heroTitle2: 'BARREL37',
    heroTitle3: 'Bar • Restaurant • Cocktails • Burgers',
    heroDesc: 'Ręcznie wyselekcjonowane trunki, intymna atmosfera i niezapomniane doznania kulinarne.',
    btnMenu: 'Poznaj Menu',
    btnBook: 'Zarezerwuj',
    scrollDown: 'Przewiń',
    ...
    findHoursMonThu: 'Pon –  Zamknięte',
    findHoursFriSat: 'Wto – Nie   11:00 AM – 12:00 AM',
    findHoursSunday: '',
    ...
    resPre: 'Rezerwacje',
    resDesc: 'Wszelkie zapytania dotyczące rezerwacji stolików prosimy kierować na adres: joinusbarrel37@gmail.com',
